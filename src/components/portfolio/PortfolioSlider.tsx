  ...
  return (
    ...
    >
      ...
      <div className="container">
        ...
        {/* Optional: Explore all projects button */}
        <div className="tp-portfolio-more tp-hover-btn-wrapper tp-btn-bounce-2 d-flex justify-content-center mt-10">
          <Link
            href="/portfolio"
