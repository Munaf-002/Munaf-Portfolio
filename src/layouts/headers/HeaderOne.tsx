              ...
              <div className="col-xl-2 col-lg-2 col-md-5 col-6">
                <div className="logo">
                  <Link className="logo-white" href="/">
                    <Image style={{ width: '115px', height: 'auto' }} src={light_logo} alt="wordpress developer" />
                  </Link>
                  <Link className="logo-black" href="/">
                    <Image style={{ width: '115px', height: 'auto' }} src={dark_logo} alt="wordpress developer" />
                  </Link>
                </div>
              </div>
              ...
              <div className="col-xl-4 col-lg-3 col-md-7 col-6">
                <div className="tp-header-right d-flex align-items-center justify-content-end">
                  ...
                  <div className="tp-header-cv ml-10 d-none d-md-block">
                    <a className="tp-header-cv-btn" href="assets/img/cv/AsifKhan-wordpress.pdf" target="_blank">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
